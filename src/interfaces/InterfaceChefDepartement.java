...
public class InterfaceChefDepartement extends JFrame {
    ...
    private JPanel createHeaderPanel() {
        ...
        headerPanel.setBackground(Color.WHITE);
        headerPanel.setBorder(BorderFactory.createEmptyBorder(15, 0, 15, 0)); // Padding horizontal à 0 pour centrage parfait
    ...
    private JPanel createNavigationPanel() {
        ...
        JButton btnCours = createNavButton("Assignation des cours", "assignation");
        JButton btnGenererPDF = createNavButton("Générer PDF", "genererpdf", new Color(50, 100, 150)); // Bleu comme les autres
        JButton btnDeconnexion = createNavButton("Déconnexion", "logout", new Color(220, 80, 60));
