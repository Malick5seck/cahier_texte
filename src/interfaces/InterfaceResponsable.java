...
public class InterfaceResponsable extends JFrame {
    ...
    public InterfaceResponsable() {
        ...
        // Panel principal avec fond gris
        JPanel mainPanel = new JPanel(new BorderLayout());
        mainPanel.setBackground(new Color(240, 240, 240));

        // Titre avec fond gris (inchangé)
        JLabel titre = new JLabel("Espace Responsable de Classe", SwingConstants.CENTER);
        titre.setFont(new Font("Arial", Font.BOLD, 20));
        titre.setBorder(BorderFactory.createEmptyBorder(20, 0, 20, 0));
        titre.setOpaque(true);
        titre.setBackground(new Color(240, 240, 240)); // Maintient le fond gris
        mainPanel.add(titre, BorderLayout.NORTH);

        // Sidebar qui occupe toute la colonne de gauche
        ...
        // Panel de contenu central avec fond blanc
        cardLayout = new CardLayout();
        contentPanel = new JPanel(cardLayout);
